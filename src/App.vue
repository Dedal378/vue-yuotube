...
<template>
  <header class="flex fixed z-30 w-full">
    <div class="w-1/4 flex">
      <div class="flex items-center w-64 bg-white pl-4">
    ...
    <div class="flex items-center w-1/2 p-2.5">
    ...
    <div class="flex items-center justify-end w-1/4 space-x-5 px-4 py-2">
      <button>
        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <button class="flex items-center px-2 py-1 text-sm text-blue-700 uppercase border border-blue-700 rounded-sm">
  ...
  <main class="md:ml-24 xl:ml-64 pt-32 px-20 sm:px-5 pb-5">
